...
<body>
 ...
 <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="person_id" ErrorMessage="Invalid CNIC format." Display="Dynamic" ForeColor="Red" ValidationExpression="\d{5}-\d{7}-\d{1}"></asp:RegularExpressionValidator>
            ...
            <div runat="server">
                ...
                <input id="email" type="text" class="form-control" runat="server" required ="required"/>
...
<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="email" ErrorMessage="Invalid email formate." Display="Dynamic" ForeColor="Red" ValidationExpression="\S+@\S+\.\S+"></asp:RegularExpressionValidator>
            ...
            <div runat="server">
                ...
                <asp:DropDownList ID="Artist_style" runat="server" class="form-control" required ="required" >
                    <asp:ListItem Value="Selection" Selected="True" Disabled="True">Choose Your Style</asp:ListItem>
                    <asp:ListItem Value="Classical">Classical Art</asp:ListItem>
                    <asp:ListItem Value=" Modern"> Modern Art</asp:ListItem>
                    <asp:ListItem Value="Contemporary">Contemporary Art</asp:ListItem>
                    <asp:ListItem Value="Folk">Folk Art</asp:ListItem>
                    <asp:ListItem Value="Mixed">Mixed Media Art</asp:ListItem>
                    <asp:ListItem Value="New">New Media Art</asp:ListItem>
                    <asp:ListItem Value="Realistic">Realistic Art</asp:ListItem>
                    <asp:ListItem Value="Abstract">Abstract Art</asp:ListItem>

                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="Artist_style" ErrorMessage="Artist_style is required." Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <div runat="server">
                ...
                <asp:DropDownList ID="Role_name" runat="server" class="form-control" required ="required">
                    ...
                    <asp:ListItem Value="Customer">Customer</asp:ListItem>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="Role_name" ErrorMessage="Role is required." Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <div runat="server">
                ...
                <input id="password" type="text" class="form-control" runat="server" required="required" />
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="password" ErrorMessage="Password is required." Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
